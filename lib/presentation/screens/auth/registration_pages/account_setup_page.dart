...
class _AccountSetupPageState extends State<AccountSetupPage> {
  ...
  void _showAddressPicker() {
    // TODO: Implement address picker with Philippine regions/provinces/cities/barangays
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Address picker will be implemented with Philippine locations',
                style: TextStyle(color: Colors.grey.shade600),
              ),
              const SizedBox(height: 24),
              ElevatedButton(
                onPressed: () {
                  // For demo, set sample address
                  final provider = context.read<RegistrationProvider>();
                  provider.setRegion('Region III');
                  provider.setProvince('Pampanga');
                  provider.setCity('Angeles City');
                  provider.setBarangay('Balibago');
                ...
                child: const Text('Use Sample Address'),
              ),
            ],
          ),
        );
            ...
            children: [
              ...
              Consumer<RegistrationProvider>(
                builder: (context, provider, child) {
                  final hasAddress = provider.region.isNotEmpty;
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            child: Text(
                              hasAddress
                                  ? '${provider.region}, ${provider.province}, ${provider.city}, ${provider.barangay}'
